...
const IssueMapPanel = ({ compact = false }) => {
  ...
  const containerClassName = compact
    ? 'relative w-full h-[34rem] lg:h-[38rem] bg-slate-900 rounded-3xl overflow-hidden border border-white/10 shadow-2xl'
    : 'relative w-full h-[calc(100vh-7rem)] md:h-[calc(100vh-4rem)] bg-slate-900';

  const overlayClassName = compact
    ? 'absolute top-4 left-4 z-[1000] bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200 px-4 py-3 w-[18rem] max-w-[calc(100%-2rem)]'
    : 'absolute top-4 left-4 z-[1000] bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-slate-200 px-4 py-3 w-64';
